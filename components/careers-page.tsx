    ...
    <MobileChrome activeMatch="/careers">
      <div className="careers-page">
        ...
        <p className="careers-deck">
          We offer an excellent work environment that encourages self-development,
          work-life balance, and professional growth. With competitive salaries,
          attractive benefits, and a peaceful campus atmosphere, we strive to
          provide a workplace that matches the highest standards in the education
          industry.
        </p>
        <p className="careers-apply-note">
          Interested candidates may apply at{" "}
          {CAREER_PHONES.map((phone, i) => (
            <span key={phone}>
              {i > 0 ? " / " : ""}
          ...
          or email{" "}
          <a href={`mailto:${CAREER_EMAIL}`}>{CAREER_EMAIL}</a>. Shortlisted
          applicants will be contacted based on current openings.
        </p>

        <section className="careers-form-card" aria-labelledby="careers-form-heading">
          {success ? (
