...
export const homeLearningHighlights = [
  {
    ...
    alt: "Value Education Lab with interactive balance scales and colorful empathy wall displays",
  },
  {
    title: "Biophilic Learning Spaces",
    badge: "CAMPUS",
    image: photos.biophilic,
    tag: "Green by design",
  ...
  },
  {
    ...
    tag: "Hands-on tech",
    alt: "AI and Robotics Lab with educational robots displayed on white worktables",
  },
  {
  ...
  },
  {
    ...
    tag: "Student voice",
    alt: "Students developing communication skills in the podcast studio",
  },
  {
